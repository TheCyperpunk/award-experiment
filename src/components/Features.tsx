  ...
  <section className="bg-black pb-52">
    <div className="container mx-auto px-3 md:px-10">
      ...
      <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-3xl md:h-[65vh]">
        <BentoCard
          src="https://res.cloudinary.com/zxgf3i2z/video/upload/f_auto,q_auto/v1782318676/original-ed9e329f7167698673aa3fe548026a8c_tvhxi1.mp4"
          title={
            <>
              com<b>i</b>t
            </>
      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
          <BentoCard
            src="https://res.cloudinary.com/zxgf3i2z/video/upload/f_auto,q_auto/v1782318587/VID-20231109-WA0019_niycqk.mp4"
            title={
              <>
        ...
        <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
          <BentoCard
            src="https://res.cloudinary.com/zxgf3i2z/video/upload/f_auto,q_auto/v1782318167/glass-abstract-vol2-dark-6_lyzt2l.mp4"
            title={
              <>
        ...
        <BentoTilt className="bento-tilt_2">
          <LazyVideo
            src="https://res.cloudinary.com/zxgf3i2z/video/upload/f_auto,q_auto/v1782318551/original-e2ebe687b4273829513b018c41beb57a_qnrrsm.mp4"
